...
public class BiomassParticleContainer extends BiomassContainer {
	 ...
	 * Shuffle the entries in the list of all the particles in the simulation.
	 * Particles are stored in a single list. The order of particles has no meaning. 
	 * In order to minimise the effect of undesired order in this list, this function shuffles
	 * the entries. Per default: called once per iteration in model.java.  
	 */
	public void shuffleParticleList(){
		Random arrayShuffle =  new java.util.Random((long) Model.model().getRandom());
		Collections.shuffle(particleList, arrayShuffle);
	}
	/**
	...
	public int performSpreadingStep() {
		// create checker for occurence of shoving in any of the
		// bacteria
		int shoved = 0;
		...
		for (Iterator iter = particleList.iterator(); iter.hasNext();) {
			...
			if (true) {
				...
				while (potentialShovers.hasNext()) {
					...
					if (neib != b && b.addOverlappingMoveDirection(neib, m)) {
						thisShoved = true;
	 ...
	 */
	private BiomassParticleSet getPotentialShovers(BiomassParticle b) {
		// Pre-allocate
		int m, n, l;
		//
		...
		// reset the array that holds the postential shoving neighbors
		_ps.reset();
	...
	public void markParticlesForErosion() {
		...
		_densityLevelSet = new DensityLevelSet(shovingGrid, liq,
				...
				(DetachmentSpeedFunction) _detachmentHandler, _model
						.getTimeStep());
	}
	...
	public void writeLevelSetUsingDiverseDetachmentFunctions()
		...
		for (int i = 0; i < functions.length; i++) {
			boolean[][][] liq = getLiquidElements();
			_densityLevelSet = new DensityLevelSet(shovingGrid, liq,
					_carrierElements, shovingGridSide, functions[i], _model
							.getTimeStep());
	 ...
	 *            bacterium to remove
	 */
	private void remove(BiomassParticle b) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.photobiofilms.model.BiomassContainer#getBiomassAsBacteriaCollection()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.photobiofilms.model.BiomassContainer#getCurrentAverageBiofilmHeight()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.photobiofilms.model.BiomassContainer#writeDetachmentLevelSet(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.photobiofilms.model.BiomassContainer#writeBiofilmFront(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.photobiofilms.model.BiomassContainer#getElementDensity(org.photobiofilms.model.ContinuousCoordinate)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see nl.tudelft.bt.model.BiomassContainer#getConcentrationInElement(nl.tudelft.bt.model.ContinuousCoordinate,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see nl.tudelft.bt.model.BiomassContainer#getEpsInElement(nl.tudelft.bt.model.ContinuousCoordinate)
	 */
