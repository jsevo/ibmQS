/*
 * Created on 10-Aug-2013 by jonas
 */
 ...
 * 
 * @author Jonas based on SbrBulkConcentration
 */
@SuppressWarnings("serial")
public class IncreasingBulkConcentration extends BulkConcentration {
	...
	private static float DEFAULTPRECISION = 0f;
	 ...
	 */
	public IncreasingBulkConcentration(float inputConcentration) {
