...
public abstract class BiomassContainer implements Serializable {
	...
	/**
	 * Shuffle entries in this list to get rid of unintentional ordering of entries. the order of entries in this list has no meaning and should be 
	 * random.
	 * @author Jonas Schluter (jonas.schluter@dtc.ox.ac.uk)
	**/
	public abstract void shuffleParticleList();
	/**
