 ...
 */
public class new4_inducerProductionVarINI_LowerPGBenefit extends ModelHandler {
	...
	private static float benefit = 1.5f;//was 3
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_inducerProductionVarINI_LowerPGBenefit();
