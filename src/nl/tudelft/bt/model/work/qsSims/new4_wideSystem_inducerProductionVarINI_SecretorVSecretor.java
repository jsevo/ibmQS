 ...
 */
public class new4_wideSystem_inducerProductionVarINI_SecretorVSecretor extends ModelHandler {
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		Reaction goodProductionTwo;
			...
			goodProductionTwo.addFactor(inducerStep);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_wideSystem_inducerProductionVarINI_SecretorVSecretor();
