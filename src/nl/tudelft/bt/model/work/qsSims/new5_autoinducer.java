 ...
 */
public class new5_autoinducer extends ModelHandler {
	...
	private static float inducerEnhancement = 1000f;
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		inducerProductionOne = new Reaction("inducerProductionOne", activeOne,
				inducerRate1, 1);
		inducerProductionOne.addFactor(autoinduction);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new5_autoinducer();
