 ...
 */
public class new4_wideSystem_inducerProductionVarINI_ConstAIVsQSAIVsWt extends ModelHandler {
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		// inducer (I)
		NetReaction rsInducer= new NetReaction(2);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_wideSystem_inducerProductionVarINI_ConstAIVsQSAIVsWt();
		...
		try {
			...
			//Model.model().setMaxHeight(maxHeight);
			 Model.model().setFinishIterationTime(48);
			 //Model.model().setMaxBiovolume(2e4f); //
