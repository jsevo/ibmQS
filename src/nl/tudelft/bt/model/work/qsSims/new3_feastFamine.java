 ...
 */
public class new3_feastFamine extends ModelHandler {
	...
	// time of initial public good production
	private static float startOfGoodProduction = 8f;
	...
	// Inducer
	protected static float inducerBulkConcentration = 1f; // [gGood/L]
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		inducer.setBulkConcentration(new ItermittentBulkConcentration(0.9f, 1.1f, 
				startOfGoodProduction, 1000f, 1000f));
	...
	public static void main(String[] args) {
		...
		startOfGoodProduction = Float.parseFloat(args[4]);
		...
		ApplicationComponent app = new new3_feastFamine();
