 ...
 */
public class new4_wideSystem_inducerProductionVarINI_QSVSecretorNoAutoInducer extends ModelHandler {
	...
	private static float inducerRate2 = 0f;
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_wideSystem_inducerProductionVarINI_QSVSecretorNoAutoInducer();
		...
		try {
			...
			//Model.model().setMaxHeight(maxHeight);
			 ...
			 //Model.model().overrideTimeStepWithSpecificTimesForAllData(0.15f,30);
