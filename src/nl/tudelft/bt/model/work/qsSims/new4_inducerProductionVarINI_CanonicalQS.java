 ...
 * 
 * Difference to the other "new4" files:
 * -to simulate the canoncial quorum sensing case we want to generate kreft's microcolonies.
 * -the idea is to show that efficiency in usage of the common good is increased when quorum sensing.
 * -for this we need a faster diffusing public good (such that it can be lost to the secretor) and a
 *  lower threshold for the effect of the common good.
 * 
 * @author Jonas Schluter (jonas.schluter+github@gmail.com)
 */
public class new4_inducerProductionVarINI_CanonicalQS extends ModelHandler {
	...
	private static float goodThreshold = 4e-3f; // the other "new4" files use 4e-3, i here do too
	...
	protected static float goodDiffusivity = 6e5f;   // [um2/h] //The other "new4" files use 3e5, i here use 6e5
	...
	protected static float inducerDiffusivity = 6e5f;   // [um2/h]
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_inducerProductionVarINI_CanonicalQS();
