 ...
 */
public class new4_wideSystem_inducerProductionVarINI_QSVSecretor extends ModelHandler {
	...
	private static float goodRate2 = 0;
	
	// Rate of inducer production
	private static float inducerRate1 = 1f; // [1/T]
	private static float inducerRate2 = 1f;
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		ProcessFactor inducerStep2 = new Step(inducer, 0f);
		...
		Reaction goodProductionTwo;
			...
			goodProductionTwo.addFactor(inducerStep2);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_wideSystem_inducerProductionVarINI_QSVSecretor();
		...
		try {
			...
			//Model.model().setMaxHeight(maxHeight);
			 ...
			 Model.model().overrideTimeStepWithSpecificTimesForAllData(0.15f,250);
