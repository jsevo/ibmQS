 ...
 */
public class new4_wideSystem_inducerProductionVarINI_matchQN_viaZ extends ModelHandler {
	...
	private static float costScale = .2437f; // 1e-5f; // scales the cost of the
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_wideSystem_inducerProductionVarINI_matchQN_viaZ();
