 ...
 */
public class new4_wideSystem_inducerProductionVarINI_doubledInvestmentIntoCoop extends ModelHandler {
	...
	private static float goodRate1 = 2; // [1/T]
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_wideSystem_inducerProductionVarINI_doubledInvestmentIntoCoop();
