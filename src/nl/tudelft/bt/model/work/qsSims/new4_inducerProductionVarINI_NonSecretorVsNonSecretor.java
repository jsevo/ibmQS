 ...
 */
public class new4_inducerProductionVarINI_NonSecretorVsNonSecretor extends ModelHandler {
	...
	public static void main(String[] args) {
		...
		inducerThreshold = Float.POSITIVE_INFINITY;
		...
		ApplicationComponent app = new new4_inducerProductionVarINI_NonSecretorVsNonSecretor();
