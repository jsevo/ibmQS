 ...
 */
public class new7_compareSize extends ModelHandler {
	...
	protected static float simulationFinishTime = 60; // [h]
	...
	public static void main(String[] args) {
		...
		systemSize = Float.parseFloat(args[5]);//Float.parseFloat(args[5]);
		...
		ApplicationComponent app = new new7_compareSize();
