 ...
 */
public class new8_alteredInducerProduction extends ModelHandler {
	...
	protected static float simulationFinishTime = 25; // [h]
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		inducerProductionOne = new Reaction("inducerProductionOne", activeOne,
				inducerRate1, 1);
		inducerProductionOne.addFactor(substrateUtil);
	...
	public static void main(String[] args) {
		...
		totalNumber = Integer.parseInt(args[3]);
		ratioOfFirstSpecies = Float.parseFloat(args[4]);
		systemSize = Float.parseFloat(args[5]);
		gridSide = Integer.parseInt(args[6]);
		inducerThreshold = Float.parseFloat(args[7]);
	
		initialParticleNumber1 = (int) (totalNumber * ratioOfFirstSpecies);
		initialParticleNumber2 = (int) (totalNumber * (1f - ratioOfFirstSpecies));
		

		relativeMaximumRadius = 1f / systemSize;

		relativeMinimumRadius = relativeMaximumRadius * 0.001f;

		relativeBoundaryLayer = (float) 25 / systemSize;
		

		// set numerics for multigrid
		MultigridVariable.setSteps(2, 20);
		// create a hande for the application, which will be decorated
		ApplicationComponent app = new new8_alteredInducerProduction();
