 ...
 */
public class new2a_constantInducerSpeciesSwap extends ModelHandler {
	...
	protected void inoculate() {
		int[] nCells = { initialParticleNumber2, initialParticleNumber1 };
	...
	public static void main(String[] args) {
		...
		inducerBulkConcentration = Float.parseFloat(args[4]);
		...
		ApplicationComponent app = new new2a_constantInducerSpeciesSwap();
