 ...
 */
public class new4_inducerProductionVarINI_ConstAIVsQSAIVsWt extends ModelHandler {
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_inducerProductionVarINI_ConstAIVsQSAIVsWt();
