 ...
 */
public class new4_inducerProductionVarINI_higherPGBenefit extends ModelHandler {
	...
	private static float benefit = 6f;//was 3
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_inducerProductionVarINI_higherPGBenefit();
