 ...
 */
public class new4_inducerProductionVarINI_ConstAIVsQSAIVsWtAI extends ModelHandler {
	...
	private static float goodRate1 = 1; // [1/T]
	private static float goodRate2 = goodRate1; // [1/T]
	// Rate of inducer production
	private static float inducerRate1 = 1f; // [1/T]
	private static float inducerRate2 = 1f; // [1/T]
	private static float inducerRate3 = 1f; // [1/T]
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		ParticulateSpecies activeThree = new ParticulateSpecies("activeThree",
		...
		BiomassSpecies speciesThree = new BiomassSpecies("speciesThree", spThree,
		...
		inducerProductionOne = new Reaction("inducerProductionOne", activeOne,
				inducerRate1, 0);
		Reaction inducerProductionTwo;
		inducerProductionTwo = new Reaction("inducerProductionTwo", activeTwo,
				inducerRate2, 0);
		Reaction inducerProductionThree;
		inducerProductionThree = new Reaction("inducerProductionThree", activeThree,
				inducerRate3, 0);
		...
		// Public Good Use
		Reaction goodUseThree;
		goodUseThree = new Reaction("goodUseThree", activeThree, benefit*uMax, 1);
		goodUseThree.addFactor(goodUtil);
		...
		rsActiveTwo.addReaction(goodProductionTwo, -costScale*uMax);
		activeTwo.setProcesses(rsActiveTwo);
		// Strain 3
		NetReaction rsActiveThree = new NetReaction(2);
		rsActiveThree.addReaction(growthThree, 1);
		rsActiveThree.addReaction(goodUseThree, 1);
		...
		// inducer (I)
		NetReaction rsInducer= new NetReaction(3);
		rsInducer.addReaction(inducerProductionOne, 1);
		rsInducer.addReaction(inducerProductionTwo, 1);
		rsInducer.addReaction(inducerProductionThree, 1);
	...
	protected void inoculate() {
		int[] nCells = { initialParticleNumber1, initialParticleNumber2, initialParticleNumber3 };
	...
	public static void main(String[] args) {
		...
		initialParticleNumber2 = (int) (totalNumber * ratioOfFirstSpecies);
		initialParticleNumber3 = (int) (totalNumber * (1f - 2*ratioOfFirstSpecies));
		...
		ApplicationComponent app = new new4_inducerProductionVarINI_ConstAIVsQSAIVsWtAI();
		...
		try {
			...
			//Model.model().setMaxHeight(maxHeight);
			 Model.model().setFinishIterationTime(24);
			 Model.model().setMaxBiovolume(2e4f); //
			 Model.model().overrideTimeStep(0.15f);
			// start the iteration
