 ...
 */
public class new4_wideSystem_inducerProductionVarINI_figure4SegregatedGenotypes extends ModelHandler {
	...
	protected void inoculate() {
		int[] nCells = { initialParticleNumber1, 0 };
		int[] nCells2 = { 0, initialParticleNumber2/2 };
		int[] nCells3 = { 0, initialParticleNumber2/2 };
		
		inoculateRandomlyAtMinHeightBetweenY1andY2(nCells, 0, systemSize-2.9f*systemSize/5,systemSize-2.1f*systemSize/5);
		inoculateRandomlyAtMinHeightBetweenY1andY2(nCells2, 0, 0, systemSize-3.1f*systemSize/5);
		inoculateRandomlyAtMinHeightBetweenY1andY2(nCells3, 0, systemSize-1.9f*systemSize/5, systemSize);
	}
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_wideSystem_inducerProductionVarINI_figure4SegregatedGenotypes();
