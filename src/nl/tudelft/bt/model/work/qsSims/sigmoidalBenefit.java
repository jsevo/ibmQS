 ...
 */
public class sigmoidalBenefit extends ModelHandler {
	...
	private static float goodHalfPoint = 0.006f;
	private static float steepness = 700;
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		ProcessFactor goodUtil = new SigmoidalGoodUtil(pGood, steepness, goodHalfPoint);
		...
		// Public good use
		Reaction goodUseOne;
		goodUseOne = new Reaction("goodUseOne", activeOne, benefit*uMax, 2);
		goodUseOne.addFactor(substrateUtil);
		...
		// Public Good Use
		Reaction goodUseTwo;
		goodUseTwo = new Reaction("goodUseTwo", activeTwo, benefit*uMax, 2);
		goodUseTwo.addFactor(substrateUtil);
	...
	public static void main(String[] args) {
		...
		goodHalfPoint = Float.parseFloat(args[4]);
		...
		ApplicationComponent app = new sigmoidalBenefit();
