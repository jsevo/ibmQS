 ...
 */
public class new4_wideSystem_inducerProductionVarINI_smallDiffusionLayer extends ModelHandler {
	...
	protected static float relativeBoundaryLayer = (float) 2.5 / systemSize;
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_wideSystem_inducerProductionVarINI_smallDiffusionLayer();
		...
		try {
			...
			//Model.model().setMaxHeight(maxHeight);
			 Model.model().setFinishIterationTime(12);
