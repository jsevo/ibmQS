 ...
 */
public class new4_wideSystem_inducerProductionVarINI_halvedInvestmentIntoCoop extends ModelHandler {
	...
	private static float goodRate1 = 0.5f; // [1/T]
	
	// Rate of inducer production
	private static float inducerRate1 = 1f; // [1/T]

	private static float costScale = .15f; // 1e-5f; // scales the cost of the
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new new4_wideSystem_inducerProductionVarINI_halvedInvestmentIntoCoop();
