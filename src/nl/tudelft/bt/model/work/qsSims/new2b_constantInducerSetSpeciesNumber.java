 ...
 */
public class new2b_constantInducerSetSpeciesNumber extends ModelHandler {
	...
	protected static float ratioOfFirstSpecies = 0.2f;
	...
	// Inducer
	protected static float inducerBulkConcentration = 2f; // [gGood/L]
	...
	public static void main(String[] args) {
		...
		+ "4: number of first species \n"
		+ "5: number of second species \n"
...
initialParticleNumber2 = Integer.parseInt(args[4]);
goodRate1 = Float.parseFloat(args[5]);
		...
		ApplicationComponent app = new new2b_constantInducerSetSpeciesNumber();
