...
import nl.tudelft.bt.model.bulkconcentrations.DynamicBulkConcentrationImplicit;
 ...
 */
public class AutotrophsEps extends ModelHandler {
...
//	60 a sufficient supply of ammonium, a constant concentration is assumed
	protected static float ammoniumBulkConcentration = 30f; //[gN-NH4/m3]
	...
	protected static float specificMassA = 341500f; //[g COD-A/m3]
	protected static float specificMassEpsA = 341500f; //[gCOD-EPS/m3]

	//Yield coefficients
	//from Picioreanu 2004 Particle based...
	private static float YA = 0.15f; //[gCOD-A/gCOD-N-NH4]
	
//	private static float YEpsA = 0.3f; //[gCOD-EPS/gCOD-H]
	...
	protected static float relativeBoundaryLayer = 20e-6f /systemSize;
	...
	private static float  endSimulationTime = 100f;
...
//				specificMassH, Color.blue);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new AutotrophsEps();
