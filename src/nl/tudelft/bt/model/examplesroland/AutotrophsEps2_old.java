 ...
 * cultivation have been used for a mass balance. From here a new yield could
 * be calculated for EPS+Bacteria-production on consumption of ammonia consumed.
 ...
 */
public class AutotrophsEps2_old extends ModelHandler {
...
//				specificMassH, Color.blue);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new AutotrophsEps2_old();
...
//		app = new SoluteRateSeriesVizualizer(app);
		...
		try {
			...
			Model.model().setMaximumBiofilmSize(BiofilmCutOffHeight);
